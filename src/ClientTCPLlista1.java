...
public class ClientTCPLlista1 {
    ...
    private void close(Socket socket){
        ...
        try {
            ...
            Logger.getLogger(ClientTCPLlista1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args) {
        ClientTCPLlista1 clientTCPLlista1 = new ClientTCPLlista1();
        clientTCPLlista1.connect("localhost", 9090);
    }
}
