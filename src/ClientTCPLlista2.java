...
public class ClientTCPLlista2 {
    ...
    private void close(Socket socket){
        ...
        try {
            ...
            Logger.getLogger(ClientTCPLlista2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args) {
        ClientTCPLlista2 clientTCPLlista2 = new ClientTCPLlista2();
        clientTCPLlista2.connect("localhost", 9090);
    }
}
